...
.dsh-collaboration-panel-login,.dsh-collaboration-panel-error{margin:12px;padding:12px;border:1px solid var(--dsw-alias-border-l2);border-radius:10px;background:var(--dsw-alias-bg-layer-1)}.dsh-collaboration-panel-error{border-color:#ef4444;color:#ef4444;white-space:pre-wrap;font-size:11px}.dsh-collaboration-panel-login-title{margin:0;font-weight:600;font-size:12px}.dsh-collaboration-panel-login a{color:#3b82f6;font-size:11px;word-break:break-all}.dsh-collaboration-panel-code{margin:8px 0;font-size:20px;font-weight:650;letter-spacing:.12em}.dsh-collaboration-panel-composer{display:flex;align-items:center;gap:8px;padding:8px 12px;border-top:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1)}.dsh-collaboration-panel-composer input{flex:1;min-width:0;height:34px;padding:0 11px;border:1px solid var(--dsw-alias-border-l2);border-radius:9px;outline:0;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-layer-2);font:11px inherit}.dsh-collaboration-panel-composer button{height:34px;padding:0 13px;border:0;border-radius:9px;color:#fff;background:#3b82f6;font:600 11px/34px inherit;opacity:.85}
